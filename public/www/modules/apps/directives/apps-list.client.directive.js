...
(function() {
	...
	function appsList(_, $uibModal, appConstants) {
		return {
			...
			controller: function() {
				...
				function appCreateInline() {
					var modalInstance = $uibModal.open({
						...
						templateUrl: 'www/modules/apps/views/partials/appCreateModal.html',
				...
				function appSelection() {
					var modalInstance = $uibModal.open({
						animation: appConstants.animationsEnabled,
						templateUrl: 'www/modules/apps/views/partials/appsModal.html',
			...
			templateUrl: 'www/modules/apps/views/partials/appsList.html'
		};
	}
})();
